            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
                    ...
                    <div className="relative z-10">
                        <h1 ref={headingRef} className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-4 sm:mb-6">
                    ...
                    <div ref={imageRef} className="relative mt-6 lg:mt-0 flex justify-center lg:justify-end">
                        <div className="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl max-w-sm lg:max-w-md xl:max-w-lg">
                            <img
                                src="/hero-team.jpg"
                                alt="CoreX Team"
